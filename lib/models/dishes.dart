...
List<Dish> dishes = const [
  ...
  Dish(
      ...
      image: "images/2.jpg",
      description:
          "Sphere of strawberry sauce stuffed vanilla cheesecake rolled in golden fried kenaefah served with lotus sauce and strawberry sauce. "),
  Dish(
      catigotyID: "1",
      id: "3",
      name: "Cookie Slab",
